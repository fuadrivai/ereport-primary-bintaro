...
class N_catatan_kl1 extends CI_Controller {
    ...
    public function simpan() {
        ...
        for ($i = 1; $i < $p['jumlah']; $i++) {
            ...
            if ($mode_form == "add") {
                ...
                $existingRecord = $this->db->query("SELECT id FROM t_catatan_kl1 WHERE ta = '" . $tasm . "' AND id_siswa = '" . $id_siswa . "'")->row();
                if (!$existingRecord) {
    ...
    public function index() {
        ...
        $this->d['siswa_kelas'] = $this->db->query("SELECT 
                                                    ...
                                                    LEFT JOIN t_catatan_kl1 c ON a.id_siswa = c.id_siswa AND c.ta = '" . $this->d['tasm'] . "'
