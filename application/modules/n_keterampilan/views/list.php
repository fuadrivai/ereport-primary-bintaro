<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h5 class="title">Skill Score &raquo; <?php echo $detil_mp['nmmapel']." - ".$detil_mp['nmkelas']; ?></h5>
            </div>
            <div class="content">
                <p>
                    <a href="#" onclick="return edit(0);" class="btn btn-info"><i class="fa fa-plus-circle"></i> Add Topic</a>
                </p>
                <ul class="list-group" id="list_kd">
                    ...
                    <?php 
                        ...
                        echo '<div class="alert alert-info">No KD has been input</div>';
                    }
                    ?>
                    <li class="list-group-item" onclick="return view_kd(<?= $detil_mp['id_mapel'].", ".$detil_mp['id_kelas']; ?>,'t');"><a href="#"><i class="fa fa-chevron-right"></i>  Midterm Score</a></li>
                    <li class="list-group-item" onclick="return view_kd(<?= $detil_mp['id_mapel'].", ".$detil_mp['id_kelas']; ?>,'a');"><a href="#"><i class="fa fa-chevron-right"></i>  Final Score</a></li>
                    <li class="list-group-item" onclick="return view_kd(<?= $detil_mp['id_mapel'].", ".$detil_mp['id_kelas']; ?>,'p');"><a href="#"><i class="fa fa-chevron-right"></i>  Practical Test Score</a></li>
                    <li class="list-group-item" onclick="return view_kd(<?= $detil_mp['id_mapel'].", ".$detil_mp['id_kelas']; ?>,'c');"><a href="#"><i class="fa fa-chevron-right"></i>  CATATAN DIKNAS</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function importFromBuzz() {
        if (!confirm("Are you certain you would like to proceed with importing scores from Buzz LMS?")) return false;
        $.ajax({
            type: "GET",
            url: base_url + "n_keterampilan/import_from_agilix/<?php echo $detil_mp['id_mapel'] . '-' . $detil_mp['id_kelas']; ?>",
            beforeSend: function () {
    ...
    function create_gradebook_items_in_buzz() {
        ...
        $.ajax({
            type: "GET",
            url: base_url + "n_keterampilan/create_gradebook_items_in_buzz/<?php echo $detil_mp['id_mapel'] . '-' . $detil_mp['id_kelas']; ?>",
            beforeSend: function () {
