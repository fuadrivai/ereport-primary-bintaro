...
class View_kelompok extends CI_Controller {
	public function __construct() {
        parent::__construct();
        $this->sespre = $this->config->item('session_name_prefix');
        $this->d['admlevel'] = $this->session->userdata($this->sespre.'level');
        $this->d['admkonid'] = $this->session->userdata($this->sespre.'konid');
        $this->d['url'] = "view_kelompok";
        $this->d['idnya'] = "viewkelompok";
        $this->d['nama_form'] = "f_view_kelompok";
    ...
    public function index() {
    	...
    	$this->d['list_mapelkelas'] = $this->db->query("SELECT 
                                                a.id, b.kd_singkat nmmapel, b.kelompok kelompok, b.nama namamapel, a.id_kelompok, a.id_kelas, c.nama nmkelas, c.tingkat
