...
class Lihat_raport extends CI_Controller {
    ...
    public function index() {
        ...
        $this->d['siswa_kelas'] = $this->db->query("SELECT s.nama,a.id_siswa,a.id_kelas,b.tingkat,a.ta,b.nama as nama_kelas FROM t_kelas_siswa a
                                                    INNER JOIN m_kelas b ON b.id = a.id_kelas
                                                    INNER JOIN m_siswa s on s.id = a.id_siswa
